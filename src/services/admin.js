...
async function createAdmin(username, Fname, Lname, Password, Salt) {
    return await db.query(`INSERT INTO Admin (AdminUsername, AdminFName, AdminLName, DateCreated, PasswordHash, Salt, AdminLastLogin) VALUES (?, ?, ?, NOW(), ?, ?, NOW())`, [username, Fname, Lname, Password, Salt])
}
